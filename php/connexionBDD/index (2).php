...
<body>
    ...
    <tbody>
        <?php
        $my_requete = 'SELECT country.code, country.name, country.population, COUNT(city.id) AS nb_ville FROM country INNER JOIN city ON country.code = city.countrycode GROUP BY countrycode ORDER BY ';
